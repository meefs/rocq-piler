...
if [[ ! -f "$INSTRUCTIONS" ]]; then
  PROMPT="Copy benchmarks/incomplete/${PROBLEM}.v to benchmarks/complete/${PROBLEM}.v and prove all Admitted theorems. For conjecture pairs (foo and foo_neg), prove exactly one of each pair. Do not modify the incomplete file."
else
