...
const t = new StdioClientTransport({ command: 'node', args: ['dist/index.js', '--coq-lsp-path', '/home/gavin/.opam/rocq-9/bin/coq-lsp'] });
const c = new Client({ name: 'q', version: '0' }, { capabilities: {} });
await c.connect(t);
