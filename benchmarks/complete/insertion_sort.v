...
Proof.
  ...
  - inversion Hs; subst; clear Hs; simpl; destruct (n <=? h) eqn:E.
    ...
    + apply sorted_cons. * apply leb_gt in E. apply PeanoNat.Nat.lt_le_incl in E. exact E. * apply sorted_single.
    + apply sorted_cons. * apply leb_le in E. exact E. * apply H2.
    + apply sorted_cons. * apply leb_gt in E. apply PeanoNat.Nat.lt_le_incl in E. exact E. * apply IH. apply H2.
Qed.
