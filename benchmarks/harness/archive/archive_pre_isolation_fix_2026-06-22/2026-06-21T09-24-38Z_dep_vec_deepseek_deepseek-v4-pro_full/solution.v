...
Proof.
  ...
  - apply T_Tail with (n := n). apply IHHstep. assumption.
  - match goal with H : has_type (tcons _ _) _ |- _ => inversion H; subst end. assumption.
  - match goal with H : has_type (tcons _ _) _ |- _ => inversion H; subst end. assumption.
Qed.
...
Lemma canonical_vec : forall v n,
...
Proof.
  ...
  - left. constructor.
  - left. constructor.
  - destruct IHHt1 as [Hhd | [hd' Hshd]].
    + destruct IHHt2 as [Htl | [tl' Hstl]].
      * left. constructor; assumption.
  ...
  - destruct IHHt as [Hv | [v' Hs]].
    + destruct (canonical_vec v n Hv Ht) as [hd [tl [Heq [Hhd Htl]]]].
      subst. right. exists hd. apply S_HeadCons; assumption.
    + right. exists (thead v'). apply S_Head; assumption.
  - destruct IHHt as [Hv | [v' Hs]].
    + destruct (canonical_vec v n Hv Ht) as [hd [tl [Heq [Hhd Htl]]]].
      subst. right. exists tl. apply S_TailCons; assumption.
